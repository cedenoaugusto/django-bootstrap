...
class RegistroUsuario(UserCreationForm):
    email = forms.EmailField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placehorder':'Prueba placehorder'}))
    ...
    class Meta:
        model = User
        fields = ('username', 'first_name', '_last_name', 'email', 'password1', 'password2')
